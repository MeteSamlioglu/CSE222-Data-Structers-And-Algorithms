...
public class Account
{
	...
	protected ArrayList<Account>Followers; //The list of the other accountss that follow this account
	protected ArrayList<Account>Following; //The list of the accounts that have been followed by this account
	protected ArrayList<Account> Blocks; // The list of the accounts that have been blocked
	...
	*/ 
	public Account(int Id, String Name_, String birthDate, String location_, Account Administration) throws Exception
	{
		...
		this.Blocks = new ArrayList<Account>( );
...
/*                      Post operations/add post/interactions...               */
	...
	/**
	 * An account that is going to be removed from Following[] array, and also Acc's followers[] array
	 * will be updated.
