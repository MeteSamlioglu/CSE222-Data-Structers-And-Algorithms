...
public class Account
{
	...
	protected LDLinkedList<Account>Followers; //The list of the other accountss that follow this account
	protected LDLinkedList<Account>Following; //The list of the accounts that have been followed by this account
	protected LDLinkedList<Account> Blocks; // The list of the accounts that have been blocked
	...
	*/ 
	public Account(int Id, String Name_, String birthDate, String location_, Account Administration) throws Exception
	{
		...
		this.Blocks = new LDLinkedList<Account>( );
...
/*                      Post operations/add post/interactions...               */
	...
	public void unBlock(Account Acc)
	{
		...
		{
			int index = Blocks.getIndexOf(Acc);
			Blocks.remove(index);
			int index2 = Acc.Blocks.getIndexOf(this);
	...
	public void unFollow(Account Acc)
	{
		...
		if(this.isAccountFollowed(Acc.getID( )) == true)
		{
			...
			index = Following.getIndexOf(Acc);
			...
			index = Acc.Followers.getIndexOf(this);
