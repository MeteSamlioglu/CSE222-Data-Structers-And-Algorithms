...
public static void main(String[] args)
    {
        ...
        try{
             ...
             long end = System.currentTimeMillis(); /*Put before execution occurs */
             double executionTime = (end - start) / 1000.0;
             System.out.println("LinkedList TestClass3 Execution time: " + String.format("%.4f",executionTime) + " seconds"); 
