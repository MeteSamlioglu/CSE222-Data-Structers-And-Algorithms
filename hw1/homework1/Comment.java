...
public class Comment extends Interaction
{
	 ...
	 */
	public Comment (int InteractionID_, Account Acc, Post PostTemp, String content_) throws Exception
	{
		super(InteractionID_, Acc, PostTemp);
		if(super.isPostActive( ))  //Checks if post has shared or not
		{	
			...
			throw new Exception("ERROR: The post that you commented has not been shared by any account!\n");
	}
